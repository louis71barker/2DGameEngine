...
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lGLEW -L/opt/Qt/5.3/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
obj/ground.o: src/ground.cpp header/ground.h \
		header/NCCA/Vec4.h \
		header/NCCA/Mat4.h
